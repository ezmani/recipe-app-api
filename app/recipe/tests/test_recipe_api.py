...
class PublicRecipeApiTests(TestCase):
    ...
    def test_auth_required(self):
        """Test that authentication is required to get recipe"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Corn on the cob')
        recipe2 = sample_recipe(user=self.user, title='Turkey')
        tag1 = sample_tag(user=self.user, name='TG Dinner')
        tag2 = sample_tag(user=self.user, name='Christmas Dinner')
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Lentil soup')
